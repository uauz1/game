  ...
  return (
    <div className="min-h-screen bg-[#07090d] text-white" dir="rtl">
      <section className="relative min-h-[calc(100vh-64px)] overflow-hidden border-b border-white/10">
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100vh-64px)] max-w-[1500px] grid-cols-1 items-center gap-8 px-5 py-10 sm:px-8 lg:grid-cols-[1fr_1.15fr_.72fr] lg:px-12 xl:px-16">
