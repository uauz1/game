...
import { QADDHA_HEADER_LOGO } from './headerLogo';
import './arena.css';
...
export default function App() {
  ...
  return <div className="app party-app" dir="rtl"><header className="topbar"><button className="brand" aria-label="قدّها الرئيسية" onClick={()=>{if(screen==='home')window.scrollTo({top:0,behavior:'smooth'});}} style={{padding:'0',margin:'0',background:'transparent',border:0,cursor:'pointer',display:'flex',alignItems:'center'}}><img src={QADDHA_HEADER_LOGO} alt="قدّها" style={{height:'clamp(88px,8vw,104px)',width:'auto',maxWidth:'420px',objectFit:'contain',display:'block',margin:'-8px 0'}}/></button><span className="topbar-caption">للجمعة اللي تستاهل</span><span className="local-play"><Monitor size={16}/> شاشة واحدة · حماس الجميع</span></header><main>
