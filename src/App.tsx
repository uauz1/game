...
export default function App() {
  ...
  return <div className="app party-app" dir="rtl"><header className="topbar"><button className="brand" aria-label="قدّها الرئيسية" onClick={()=>{if(screen==='home')window.scrollTo({top:0,behavior:'smooth'});}} style={{padding:'0',background:'transparent',border:0,cursor:'pointer'}}><img src={QADDHA_HEADER_LOGO} alt="قدّها" style={{height:'72px',width:'auto',maxWidth:'330px',objectFit:'contain',display:'block'}}/></button><span className="topbar-caption">للجمعة اللي تستاهل</span><span className="local-play"><Monitor size={16}/> شاشة واحدة · حماس الجميع</span></header><main>
