...
const games = [
  ...
  {id:'pressure',title:'تحت الضغط',desc:'عدد محدد من الإجابات ووقت يركض. هل تقدرون تكملون قبل الصافرة؟',icon:Flame,tag:'سرعة + معرفة',cover:asset('pressure-cover.webp'),ready:true},
  {id:'intruder',title:'الدخيل',desc:'أربع اختيارات بينها عنصر واحد ما ينتمي للباقي. اكتشفوه وفسّروا السبب.',icon:ShieldQuestion,tag:'ذكاء + استنتاج',cover:asset('intruder-cover.webp'),ready:true},
];
