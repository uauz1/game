...
import { ArrowLeft, ChevronLeft, Trophy, Users, Sparkles, Brain, Camera, Zap, UserRound, Puzzle, Gamepad2, Monitor, Settings as SettingsIcon } from 'lucide-react';
...
export default function App() {
  ...
  </main><footer><span>قدّها <b>✦</b></span><p>جمعتكم أحلى بالتحدّي</p></footer><SiteSettings open={settingsOpen} onClose={()=>setSettingsOpen(false)}/></div>;
}
