...
const isAdmin = params.get('admin') === '1' || window.location.pathname === '/admin' || window.location.pathname === '/admin/';
  ...
  <StrictMode>
    <ErrorBoundary>
      {isWhoHost
        ...
        : <AuthProvider>{isAdmin ? <Suspense fallback={<main dir="rtl" style={{minHeight:'100vh',display:'grid',placeItems:'center',background:'#080808',color:'#fff'}}>جاري فتح لوحة قدّها…</main>}><QaddhaAdminDashboard /></Suspense> : <App />}</AuthProvider>}
    </ErrorBoundary>
  </StrictMode>
);
