...
export default function MultiplayerPlayer({ code }: { code: string }) {
  ...
  const [choiceMode,setChoiceMode] = useState<'single'|'sequence'>('single');
